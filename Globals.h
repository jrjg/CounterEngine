...
typedef enum { EVENT_NULL, EVENT_KEYDOWN, EVENT_KEYUP, EVENT_MOVEBACK, EVENT_MOVELEFT, EVENT_MOVERIGHT, EVENT_MOVEFORWARD, EVENT_RESTORE, EVENT_RELEASE, EVENT_MOVEUP, EVENT_MOVEDOWN} EVENTTYPE;
